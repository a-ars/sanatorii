...
<script>
	$(document).ready(function(){
		...
		if(arResortOptions['THEME']['PHONE_MASK'].length){
			...
			$('.contacts form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.phone').inputmask("mask", { "mask": arResortOptions['THEME']['PHONE_MASK'] });
		...
		$('.contacts form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.date').inputmask(arResortOptions['THEME']['DATE_MASK'], { 'placeholder': arResortOptions['THEME']['DATE_PLACEHOLDER'] });
